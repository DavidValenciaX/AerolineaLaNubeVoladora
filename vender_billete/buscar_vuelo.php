...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["buscar"])) {
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<table border='1'>";
            echo "<tr><th>ID</th><th>Avión</th><th>Fecha</th><th>Origen</th><th>Destino</th><th>Precio</th><th>Hora</th><th>Asientos Disponibles</th><th>Estado</th><th>Acciones</th></tr>";
            while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td>" . $row["ID"] . "</td>";
                ...
                echo "<td><a href='seleccionar_asiento.php?vuelo_id=" . $row["ID"] . "'>Seleccionar vuelo</a></td>";
                echo "</tr>";
            }
            echo "</table>";
        } else {
